...
def main() -> None:
    ...
    scorer = build("backbone", model_name=args.model_name, readout=args.readout, fusion_weight=args.fusion_weight, debias=args.debias, adapter=args.adapter, head_path=args.head)
