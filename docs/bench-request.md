# [bench request]: Add Compass 0.1.1 (Qwen3.5-4B frozen, candidate-verification readout, TypeSafe wire format)
...
python -m jevbench.cli run --tasks datasets/public/original.jsonl \
  --adapter typesafe --endpoint http://127.0.0.1:8000 --key-env '' --model compass-0.1.1 \
