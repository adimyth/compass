...
ADAPTER = "adimyth/compass-lora-v2"  # Stage B v2 LoRA (docs/EXPERIMENTS.md), merged into the backbone at load
...
READOUT = "fusion"
FUSION_WEIGHT = 0.5
DEBIAS = 0.0  # content-free prior subtraction weight (docs/EXPERIMENTS.md); 0 in compass-0.1.1
